...
def main():
    ...
    for i in range(len(PATHWAYS)):
        ...
        G0_file = construct_G0(p,args.G0_dir,args.DAG_prefix,args.new_G0_dir,c)
...
def construct_G0(pathway,original_dir,DAG_prefix,new_dir,c):
    ...
    DAG_path = DAG_prefix+'/'+pathway +'_c%d_k100.txt' % (c)
    edges = set()
