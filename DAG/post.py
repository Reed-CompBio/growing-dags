...
edge_styles = {True : "solid", False : "dashed"}
...
def createGSGraph(pathway):
    ...
    with open(pathway+"-output.txt") as output_file:
        for line in output_file:
            ...
            output_nodes.add(nodes[-1]) # Adding last node because range above in len(nodes) -1
    ...
    for i in output_edges:
        ...
        G.add_edge_style(i[0], i[1], directed = True, width = 1, edge_style = edge_styles[inPathway])
